...
namespace Models.FrameWork
{
    ...
    public partial class JavaFloristEntities : DbContext
    {
        ...
        public virtual ObjectResult<ProCartDetails_Create_Result> ProCartDetails_Create(Nullable<int> id_Cart, Nullable<int> id_Bou, Nullable<int> volume, Nullable<decimal> total_price)
        {
            var id_CartParameter = id_Cart.HasValue ?
                new ObjectParameter("id_Cart", id_Cart) :
                new ObjectParameter("id_Cart", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProCartDetails_Create_Result>("ProCartDetails_Create", id_CartParameter, id_BouParameter, volumeParameter, total_priceParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> ProCus_Create(string email, string password, string firstName, string lastName, string image, Nullable<System.DateTime> birth, Nullable<int> id_Gender, string phone, string address, Nullable<int> id_Role)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("ProCus_Create", emailParameter, passwordParameter, firstNameParameter, lastNameParameter, imageParameter, birthParameter, id_GenderParameter, phoneParameter, addressParameter, id_RoleParameter);
        }
        ...
        public virtual ObjectResult<ProCus_ReadMulti_Result> ProCus_ReadMulti()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProCus_ReadMulti_Result>("ProCus_ReadMulti");
        }
